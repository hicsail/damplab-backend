...
// TODO: Remove once database is used
const services: DampLabService[] = [
  {
    id: 'seq',
  ...
  },
  {
    ...
    allowedConnections: ['run-gel', 'dpn1'],
    result: {
      id: 'pcr-product',
      type: 'PCRResult',
      result: {
  ...
  },
  {
    ...
    parameters: [],
    allowedConnections: ['run-gel', 'column-purification'],
    result: {
      id: 'dpn1-product',
      type: 'Dpn1Result',
      result: {
  ...
  },
  {
    ...
    allowedConnections: ['column-purification'],
    result: {
      id: 'gel-product',
      type: 'GelResult'
    }
  },
  {
    ...
    allowedConnections: ['assembly', 'dna-gel']
  },
  {
    id: 'dna-gel',
  ...
  },
  {
    ...
    parameters: [],
    allowedConnections: ['overnight-culture', 'plate-storage'],
    result: {
